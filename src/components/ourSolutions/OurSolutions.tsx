    ...
    return (
        <div className="ourSolutions">
            <div className="OurSolutionsWrapper">
                <strong className="OurSolutionsTitle"><span>//</span>Nossas soluções</strong>
                        ...
                        return (
                            <div className="OurSolutionsCard">
                                ...
                                <div className="OurSolutionsCardInfo">
                                    ...
                                    <p className="OurSolutionsCardDescription">{item.productDescription}</p>
                                    ...
                                    <button className="OurSolutionsCardButton">Ver solução</button>
                                </div>
                            </div>
                        )                        
                    })}
