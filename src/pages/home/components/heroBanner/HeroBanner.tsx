        ...
        <div className="heroBanner">
            <div className="heroBannerWrapper">
                <div className="heroBannerInfo">
                    ...
                    <p className="heroBannerSubtitle">A Jüssi é especialista na criação de lojas usando a plataforma VTEX. Precisa criar sua loja ou migrar de plataforma?</p>
                    <a href="/" className="heroBannerLink">Veja nossas soluções</a>
                </div>
