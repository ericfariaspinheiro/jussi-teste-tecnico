...
const NotFound: React.FC<NotFoundProps> = ({ searchTerm }) => {
    ...
    return (
      <div className="searcNotFound">
        ...
        <strong className="searcNotFoundTitle">Não encontramos nenhum resultado para "{searchTerm}”.</strong>
        ...
        <a href="/" className="searcNotFoundLink">Ir para a página inicial</a>
        </div>
      </div>
    )
